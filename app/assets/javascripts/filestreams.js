...
$(function() {
  ...
  $('#fileupload').bind('fileuploadadd', function (e, data) {
      ...
      $.getJSON('filestreams/generate_key.json', {filename: file_name}, function(data) {
  ...
  $('#fileupload').bind('fileuploaddone', function (e, data) {
      ...
      $.post('filestreams.json',
          {
            'filestream[url]': $(data.result).find('Location').text(),
            'filestream[bucket]': $(data.result).find('Bucket').text(),
            'filestream[key]': $(data.result).find('Key').text(),
   ...
   $('#fileupload').bind('fileuploaddestroyed', function (e, data) {
      ...
      $('#filestream_' + data.object_id).remove();
   });
